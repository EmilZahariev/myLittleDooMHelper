...
# This script installs the latest development versions of GZDoom, Zandronum and Doomseeker. Run it on PCLinuxOS based systems.
# Do not execute it with root permissions (sudo). At the approprate points it will ask for your sudo password.
# Make the script executable with "sudo chmod +x PCLinuxOSBasedDoomInstall.sh" and execute with "./PCLinuxOSBasedDoomInstall.sh".
